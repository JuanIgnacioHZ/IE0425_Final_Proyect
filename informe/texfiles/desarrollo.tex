    ...
    \subsection{Lista de equipo}
        ...
        \subsubsection{Electrónica de Red}
            ...
            \begin{xltabular}{\linewidth}{|>{\f}X|>{\f}X|>{\f}X|>{\f}X|}
                ...
                \hline 
                \endfirsthead
                \caption[]{Lista de tipos de electrónica de red utilizada (Cont.)} \\
                \hline
                \textbf{Equipo} & \textbf{Proveedor} & \textbf{Precio Unitario} & \textbf{Descripción} \\   
                \hline
                \endhead
        ...
        \subsubsection{Cableado Estructurado}
            ...
            \begin{xltabular}{\linewidth}{|>{\f}X|>{\f}X|>{\f}X|>{\f}X|}
                ...
                \hline 
                \endfirsthead
                \caption[]{Lista de materiales para la canalización de la red (Cont.)} \\
                \hline
                \textbf{Equipo} & \textbf{Proveedor} & \textbf{Precio Unitario} & \textbf{Descripción} \\   
                \hline
                \endhead
...
\section{Presupuesto de Red}
    ...
    Tomando en cuenta todo lo descrito anterior mente, se presenta
    en la tabla \ref{tab: presupuesto} la cantidad base nesesaria
    de dinero para establecer la red funcional, tomando únicamente
    el costo del equipo a ser instalado.
    ...
    \begin{xltabular}{\linewidth}{|>{\f}X|>{\f}X|>{\f}X|>{\f}X|}
        ...
        %\addtocounter{table}{-1} \\
        \hline
        \textbf{Equipo} & \textbf{Cantidad x Precio} & \textbf{sub-total} & \textbf{justificación} \\   
        \hline 
        \endfirsthead
        ...
        ISR4331                           & 1 x \$1,066.00      & \$1,066.00 & Un único router. \\  \hline
        WS-C2960+24TC-S                   & 3 x \$472.00        & \$1,416.00 & Dos switches internos, uno visitante. \\  \hline
        EAP610                            & 3 x \$80.99         & \$242.97   & Dos puntos de acceso internos, y uno visitante. \\  \hline
        UCS C220 M5                       & 3 x \$773.00/735.00 & \$2,243.00 & 1 Servidor con tarjetas de red, dos sin tarjeta. \\  \hline
        Extensión eléctrica 16 AWG        & 10 x \$5.96         & \$59.6     & Alimentación de los 10 componentes anteriores con la UPS. \\  \hline
        BE600M1 Back-UPS                  & 2 x \$85.49         & \$170.98   & Una UPS para cada zona con equipo. \\  \hline
        CANASTA ELECTROZINC 100x65x3000mm & 50m x \$16.95/3m    & \$282.5    & Para guia de cableado sobre el techo. \\  \hline
        Canaleta de 200 x 10 x 5 cm       & 22m x \$16.31/2m    & \$179.41   & Para cables que bajan del techo o atraviezan el piso. \\  \hline
        RJ-45 (50ft)                      & 4 x \$8.52          & \$34.08    & Para 2 conexiones de oficina de manager, 1 troncal entre sw5 y sw6, y 1 para punto de acceso de workstation. \\ \hline
        RJ-45 (5ft)                       & 5 x \$4.99          & \$24.95    & 1 troncal entre sw4 y sw6, uno para cada servidor, 1 troncal con el router. \\ \hline
        RJ-45 (25ft)                      & 4 x \$6.99          & \$27.96    & 2 para recepción, dos para puntos de acceso. \\ \hline
        \textbf{total}                    &                     & {\it \$5,747.45} & Sin contar computadoras fijas ni sueldos. \\ \hline
    \end{xltabular}

    Basandose en precios de computadoras, monitores, teclados e
    impresoras de \href{https://www.intelec.co.cr/computadoras-gaming/}{intelec},
    se utiliza \$600 como valor utilitario para PCs, para una
    cantidad de 17 unidades, y \$120 para impresoras como valor
    utilitario para 5 unidades, donde se toma en cuenta
    el cable RJ-45 de 50ft para 22 unidades; el precio
    total es {\bf \$16,734.89} para la infraestructura.
    Trabajo de ingeniería suma \$2000 más.
